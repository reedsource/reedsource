...
public class FoundSqliteTest {
    ...
    public void test() throws TopException {
        ...
        // 1. 连接一个数据库
        FoundSqlite foundSqlite = new FoundSqlite("jdbc:sqLite:" + DealFile.getUserTestCacheFile() + "\\data\\DealSqliteTest.db", false);
        ...
        // 1. 约定 连接一个数据库
        FoundSqlite fSqlite = new FoundSqlite("jdbc:sqLite:" + DealFile.getUserTestCacheFile() + "\\data\\DealSqliteTest1.db");
