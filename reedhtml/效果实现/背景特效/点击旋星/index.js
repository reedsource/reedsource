...
(function () {
    ...
    //var backgroundColor = 'transparent';//背景色
    var backgroundColor = '#070712';//背景色
    ...
    function render() {
        ...
        var f = ctx.createLinearGradient(-canvasEl.width,canvasEl.height,canvasEl.height,canvasEl.width);
       /* f.addColorStop(0.1,"red")
        f.addColorStop(0.5,"blue")
        f.addColorStop(0.9,"green")*/
        f.addColorStop(0.1,"#030355");
        f.addColorStop(0.5,"#03033E");
        f.addColorStop(0.9,"#050521");
        f.addColorStop(1,"#070712");
